...
export default function AutoSurveyForm() {
  ...
  return (
    <>
      ...
      <CardHeader className="border-b-2 border-yellow-400/40 py-3">
        <CardTitle className="text-2xl text-center text-yellow-300 font-bold drop-shadow-xl" style={{
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg font-bold text-yellow-300" style={{
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm">Ваше имя *</FormLabel>
                        <FormControl>
                ...
                <div className="space-y-2 pt-2 border-t border-yellow-400/30">
                  <h3 className="text-lg font-bold text-yellow-300" style={{
                    textShadow: '0 0 10px rgba(255,215,0,0.6)'
                  }}>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-sm">Марка *</FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-sm">Модель *</FormLabel>
                          <FormControl>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-sm">Год *</FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-sm">Цвет</FormLabel>
                          <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm">Пробег</FormLabel>
                        <FormControl>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm">Коробка передач *</FormLabel>
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue placeholder="Тип коробки" />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm">Тип топлива *</FormLabel>
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          <FormControl>
                            <SelectTrigger>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm">Тип привода *</FormLabel>
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          <FormControl>
                            <SelectTrigger>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="1-2 млн руб" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <div className="space-y-2 pt-2 border-t border-yellow-400/30">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm">Дополнительные пожелания</FormLabel>
                        <FormControl>
                          <Textarea
            ...
            {submitStatus === 'success' && (
              <div className="bg-green-900/50 backdrop-blur-sm text-yellow-300 p-3 rounded-lg border-2 border-yellow-400/70">
                <p className="font-bold mb-1">Заявка успешно отправлена!</p>
                <p className="text-sm text-white/90">Спасибо за обращение. Мы свяжемся с вами в ближайшее время!</p>
              </div>
            )}

            {submitStatus === 'error' && (
              <div className="bg-red-900/70 backdrop-blur-sm text-yellow-200 p-3 rounded-lg border-2 border-red-500/70">
                <p className="font-semibold mb-1">Ошибка отправки</p>
                <p className="text-sm">Пожалуйста, попробуйте еще раз.</p>
              </div>
            )}

            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-red-600 to-green-700 hover:from-red-700 hover:to-green-800 text-white font-bold text-base border-2 border-yellow-400/50 shadow-lg glow-effect py-5"
